...
export const obaidulQuader: PersonProfile = {
  ...
  primaryAreaBn: "নোয়াখালী",
  primaryAreaEn: "Noakhali",
  influenceDomains: ["POLITICS", "PUBLIC_CONTRACTS", "PATRONAGE"],
  historicalIdentityBn:
    "আওয়ামী লীগের সাধারণ সম্পাদক ও জাতীয় রাজনীতির গুরুত্বপূর্ণ সংগঠক হিসেবে দলীয় নেতৃত্ব, মন্ত্রণালয় ও নির্বাচনী রাজনীতিতে আলোচিত ব্যক্তি।",
  historicalIdentityEn:
    "A nationally visible party organizer discussed through Awami League leadership, ministerial office, and electoral politics.",
  narrative: {
    whyListedBn:
      "ওবায়দুল কাদের জাতীয় দলীয় নেতৃত্ব, মন্ত্রণালয় ও সংসদীয় রাজনীতির সঙ্গে দীর্ঘ সময় যুক্ত থাকায় প্রোফাইলটি অন্তর্ভুক্ত।",
    whyListedEn:
      "Obaidul Quader is included because of his long association with national party leadership, ministerial office, and parliamentary politics.",
    historicalOverviewBn:
      "প্রকাশ্য উৎসে তাকে আওয়ামী লীগের সাধারণ সম্পাদক, মন্ত্রী এবং সংসদ সদস্য হিসেবে উল্লেখ করা হয়।",
    ...
    publicReputationEn:
      "The profile is published as a biographical and initial public record; it does not present relationships as proof of wrongdoing.",
    legacyBn:
